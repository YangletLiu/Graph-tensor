...
/********************step three:采样**************************/
    ...
    int miss_index[num_miss_frame]={4,8,5,7,2};
#if 0
...
/**************************step four: Alter-Min**************************/
    for(int iter = 0; iter < atoi(argv[4]); iter++){
    //printf("iter %d\n", iter);
...
/**************************step five:误差计算**************************/
    ...
    printf("\tFrame: %d\tError: %lf\t Time: %lf\t Iter: %d\n", k, res, time, atoi(argv[4]));
