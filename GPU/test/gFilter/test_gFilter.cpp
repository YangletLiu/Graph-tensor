...
int main(int argc, char* argv[]){
	...
	if(0 == strcmp("batched", argv[4])){
		...
		case 2:
			...
			break;
		case 3:
			gFilter_3D_batched_d(d_U, S, d_f, m, n, k, d_F);
			break;
		default:
			break;
		}
		...
		case 2:
			...
			break;
		case 3:
			gFilter_3D_based_d(d_U, S, d_f, m, n, k, d_F);
			break;
		default:
			break;
		}
	...
	switch(d){
	case 1:
		printf("gFilter_%dD_%s of G[%d*%d] time: %lfs\n", d, argv[4], k, m, time);
		break;
	case 2:
		printf("gFilter_%dD_%s of G[%d*%d] time: %lfs\n", d, argv[4], k, m, time);
		break;
	case 3:
		printf("gFilter_%dD_%s of G[%d*%d*%d] time: %lfs\n", d, argv[4], m, n, k, time);
		break;
	default:
		break;
	}
